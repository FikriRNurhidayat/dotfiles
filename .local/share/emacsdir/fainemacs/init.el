...
(custom-set-variables
 ...
 '(package-selected-packages
   '(evil-collection evil ox-gfm visual-fill-column org-bullets markdown-mode yaml-mode magit counsel-projectile projectile which-key counsel ivy rainbow-delimiters doom-themes doom-modeline all-the-icons use-package)))
(custom-set-faces
